...
def get_waveform(static_arguments,
    ...
    simulation_parameters = dict(approximant=static_arguments['approximant'],
                                 coa_phase=static_arguments['coa_phase'],
                                 ...
                                 mass1=static_arguments['mass1'],
                                 mass2=static_arguments['mass2'],
...
def get_detector_signals(static_arguments,
    ...
    right_ascension = static_arguments['ra']
    declination = static_arguments['dec']
