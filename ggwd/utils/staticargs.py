...
def typecast_static_args(static_args):
    ...
    args['coa_phase'] = float(args['coa_phase'])
    args['inclination'] = float(args['inclination'])
    args['ra'] = float(args['ra'])
    args['dec'] = float(args['dec'])
    args['polarization'] = float(args['polarization'])
    
    # parameters vary in different dataset
    args['spin1z'] = float(args['spin1z'])
    args['spin2z'] = float(args['spin2z'])
    args['injection_snr'] = float(args['injection_snr'])
    args['mass1'] = float(args['mass1'])
    args['mass2'] = float(args['mass2'])
